  ...
  if (kIsWeb) {
    await Firebase.initializeApp(
      options: const FirebaseOptions(
          apiKey: "AIzaSyA6MAwP0Af-QaW6PjAI1MDwKkb-jVsovvc",
          appId: "1:357453323748:web:0aa6031d2d9349f08a7bf1",
          messagingSenderId: "357453323748",
          projectId: "paws-app-1",
          storageBucket: 'paws-app-1.appspot.com'),
    );
  } else {
    await Firebase.initializeApp();
  }
